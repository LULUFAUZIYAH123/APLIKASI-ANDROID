package com.example.uasandroid1lulu
...
import com.example.uasandroid1lulu.model.Note
...
class NoteAdapter(
    ...
    class NoteViewHolder(itemView: View):RecyclerView.ViewHolder(itemView){
        var textViewNpm = itemView.findViewById<TextView>(R.id.text_view_title)
        var textViewNama = itemView.findViewById<TextView>(R.id.text_view_body)
    ...
    override fun onBindViewHolder(holder: NoteAdapter.NoteViewHolder, position: Int) {
        ...
        holder.textViewNpm.text = "NPM: ${item.title}"
        holder.textViewNama.text = "Nama: ${item.body}"
